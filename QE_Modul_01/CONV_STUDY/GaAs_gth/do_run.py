...
atoms = Atoms('AsGa', positions=[
    [      1.4134250000,       1.4134250000,       1.4134250000],
    [      0.0000000000,       0.0000000000,       0.0000000000],
    ],
    pbc = [True, True, True],
    cell=[
    [      2.8268500000,       0.0000000000,       2.8268500000],
    [      2.8268500000,       2.8268500000,       0.0000000000],
    [      0.0000000000,       2.8268500000,       2.8268500000],
    ]
)
atoms.write('ATOMS.xsf')

pspFiles = ["As.gth", "Ga.gth"]
